...
env LC_ALL=en_US.UTF-8 perl $PWD/multi-bleu.pl $PWD/data/tmp/truecased/train.${tgt} < ${PWD}/results/${MODEL_NAME}/train.${tgt} >> ${PWD}/results/${MODEL_NAME}/train_result.txt
